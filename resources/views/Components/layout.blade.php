                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                <!-- request() -> is('/') means if the current request matches '/', if yes then add bg-gray-900 and text-white classes -->                        
                                <x-nav-link href="/" :active="request()->is('/')">Home</x-nav-link>
                                <x-nav-link href="/jobs" :active="request()->is('jobs')">Jobs</x-nav-link>
                                <!-- :active is a prop and the : before the prop means the value is treated as an expression, 
                                 without it the value is treated as a string -->
